...
from .client import BubbleForumClient
from .parser import BubbleForumParser

logger = logging.getLogger(__name__)

class BubbleForumAgent(BaseSourceAgent):
    @property
    def source_name(self) -> str:
        return "bubble_forum"

    def __init__(self):
        self.client = BubbleForumClient()
        self.parser = BubbleForumParser()
